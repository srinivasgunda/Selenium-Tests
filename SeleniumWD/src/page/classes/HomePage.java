...
public class HomePage {
	...
	public static WebElement allCases(WebDriver driver) {
		element = driver.findElement(
				By.xpath("html/body/div[1]/div/div[2]/div[1]/div/div/div[1]/div/div[1]/div[1]/span/span[4]"));
		return element;
	...
	public static WebElement logoutButton(WebDriver driver) {
		element = driver.findElement(By.cssSelector(".omnyx-button.viewer-toolbar-right-logout"));
		return element;
	...
	public static void typeCaseName(WebDriver driver) throws InterruptedException {
		element = searchBox(driver);
		element.sendKeys("W-Integration Changed");
		Thread.sleep(2000);
