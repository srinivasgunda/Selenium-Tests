...
public class MyDemo {
	...
	public static void main(String[] args) throws Throwable {
		...
		String baseUrl = "https://pghvm-vr1-www1.omnyx.com/Omnyx.Web/login";
		driver.get(baseUrl);
		...
		// Click on All Cases
		driver.findElement(By.xpath("html/body/div[1]/div/div[2]/div[1]/div/div/div[1]/div/div[1]/div[1]/span/span[4]"))
				.click();
		...
		// Search for a case
		driver.findElement(By.className("search-textbox")).sendKeys("W-Integration changed");
		...
		WebElement element = driver.findElement(By.xpath("//div[text()='W-Integration changed']"));
		...
		// Logout
		driver.findElement(By.cssSelector(".omnyx-button.viewer-toolbar-right-logout")).click();
